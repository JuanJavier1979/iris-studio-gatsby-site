                    ...
                    <main id="main" className="site-main large-12 columns">
                        <article id="post-564" className="post-564 page type-page status-publish post-password-required hentry">
                            <div className="entry-content">
                                ...
                                <p>Estoy especialmente enfocado en desarrollo WordPress y diseño de temas personalizados. Actualmente trabajo en Pragmatic Agency, UK.</p>
                                <p>Vivo en Málaga, aunque trabajo en remoto y me encanta.</p>
                                <h2>Sobre mí…</h2>
